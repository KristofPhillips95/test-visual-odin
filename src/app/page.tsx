...
import {MultiLineChart,SingleLineChart,ImbaChart,CombinedBarLineForecastAndHistChart} from "../utils/prepareCharts";
...
export default function Home() {
  ...
  return (
    <div className="p-8">
      ...
      {/* {st_data && <CombinedBarLineForecastAndHistChart title ={"Operational Decisions"} x_labels={labelsLT} x_labels_fc={labels_fc} barData={netDischarge} lineData={soc} lineDataFc={si_fc} price_label = "SOC" si_label = "Net Discharge" price_color = " rgb(17, 18, 18)" si_color = "rgb(208, 105, 20)" />} */}
